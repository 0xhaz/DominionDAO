      ...
      <nav className="navbar navbar-expand-lg shadow-md py-2 relative flex items-center w-full justify-between bg-white dark:bg-[#212936]">
        <div className="px-6 w-full flex flex-wrap items-center justify-between">
          <div className="grow flex flex-row justify-between items-center p-2">
            <Link
              to="/"
              className="flex flex-row justfiy-start items-center space-x-3"
              href="#"
            >
              <FaUserSecret className="cursor-pointer" size={25} />
              <span className="invisible md:visible">Dominon</span>
            </Link>
            ...
            <div className="flex flex-row justify-center items-center space-x-5">
              ...
              {connectedAccount ? (
                <button
                  ...
                  focus:ring-0 active:bg-blue-800 dark:shadow-transparent active:shadow-lg
